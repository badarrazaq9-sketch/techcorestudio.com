  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(53,64,255,0.1) 0%, transparent 70%)",
          x: mousePos.x * 0.8,
          y: mousePos.y * 0.8,
        }}
        animate={{
      ...
      {/* Main Content */}
      <motion.div
        className="relative z-10 max-w-6xl mx-auto px-6 text-center pt-36"
      ...
      >
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold text-white leading-[1.05] tracking-tight">
            <motion.span
        ...
        {/* Description */}
        <motion.p
          className="px-6 text-sm md:px-0 md:text-xl text-gray-400 max-w-2xl mx-4 mb-6 md:mb-12 leading-relaxed"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 1.1 }}
        >
          A UK & USA-based software house crafting enterprise-grade digital
          solutions. We transform complex challenges into elegant, scalable
          products that drive global growth.
        </motion.p>
        ...
        >
          <p className="text-xs text-gray-600 uppercase tracking-[0.25em] mb-8">
            Powering innovation for global enterprises
          </p>
          <div className="flex items-center justify-center gap-10 md:gap-16 opacity-30">
            {["Google", "Microsoft", "Amazon", "Meta", "Apple"].map(
              (brand) => (
                <motion.span
                  key={brand}
                  className="text-lg font-semibold text-gray-500 hover:text-gray-300 transition-colors duration-300 cursor-default"
