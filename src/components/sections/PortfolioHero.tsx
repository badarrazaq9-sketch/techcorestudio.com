...
import { MapPin, Sparkles, ArrowDown, Briefcase, Layers, Code, Brain } from "lucide-react";
import Link from "next/link";

const portfolioStats = [
  { value: "300+", label: "Projects Delivered", icon: <Briefcase size={16} /> },
  { value: "50+", label: "Enterprise Clients", icon: <Layers size={16} /> },
  { value: "100%", label: "Custom Solutions", icon: <Code size={16} /> },
  { value: "AI", label: "Powered Projects", icon: <Brain size={16} /> },
];
...
const portfolioSchema = {
  ...
  "@graph": [
    ...
    {
      "@type": "CollectionPage",
      "@id": "https://techcore.studio/portfolio",
      url: "https://techcore.studio/portfolio",
      name: "TechCore Studio Portfolio",
      description: "Explore our latest projects across web development, mobile apps, UI/UX design, branding, and AI-powered solutions.",
  ...
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden pt-32 pb-20">
      ...
      >
            ...
            >
              ...
              <span className="relative inline-block">
                ...
                >
                  ...
                  />
                  <defs>
                    <linearGradient id="portfolioGradient" x1="0" y1="0" x2="300" y2="0">
        ...
        >
          Explore our latest projects across web development, mobile apps, UI/UX design,
          branding, and AI-powered solutions. Each project reflects our commitment to excellence.
        </motion.p>
